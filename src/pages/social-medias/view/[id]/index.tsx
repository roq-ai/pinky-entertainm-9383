...
import { getSocialMediaById } from 'apiSdk/social-medias';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Social Media Detail View
          </Text>
          {hasAccess('social_media', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/social-medias/edit/${data?.id}`} passHref legacyBehavior>
              <Button
